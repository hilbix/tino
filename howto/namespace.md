...
```
mem3:::::/sys/fs/cgroup/memory:/bin/bash:-c:NAME=memlimit; mkdir -p $NAME; echo 3G > $NAME/memory.limit_in_bytes; echo 6G > $NAME/memory.memsw.limit_in_bytes; echo 1G > memory.soft_limit_in_bytes; echo $PPID >> $NAME/tasks
```
